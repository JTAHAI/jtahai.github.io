...
<div class="hero">
  <div class="hero__brand">
    <img class="hero__mark" src="/assets/img/jt-monogram.png" alt="JT monogram">
    <div class="hero__title">Justin Tahai</div>
    <div class="hero__subtitle">Systems engineer • static-first • accessibility-first</div>
  </div>
  <div class="hero__body">
    <p>
      I build durable, accessible, low-friction systems — and I write down the parts that matter: tradeoffs, checklists,
      and the boring architecture that keeps things reliable over time.
    </p>
    <div class="cta-row">
      <a class="btn" href="/why-static-first/">Why I build static-first</a>
      <a class="btn btn-ghost" href="/checklists/static-launch-checklist/">Static launch checklist</a>
    </div>
  </div>
</div>
